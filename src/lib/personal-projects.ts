...
export const PERSONAL_PROJECTS: Project[] = [
  ...
  // --- SYSTEMS & INFRASTRUCTURE ---
  {
    ...
    visibility: "Public",
    aiSummary:
      "An advanced object-relational database engine from scratch, featuring strict query parsing, execution pipelines, and optimized disk I/O.",
    techStack: ["C", "C++"],
  ...
  },
  {
    ...
    visibility: "Public",
    aiSummary:
      "A low-level HTTP/1.1 server engineered entirely from scratch over raw TCP sockets with manual protocol parsing.",
  ...
  },
  {
    ...
    visibility: "Public",
    aiSummary:
      "An event-driven C library leveraging libpq to process asynchronous PostgreSQL NOTIFY signals with near-zero overhead.",
  ...
  },
  {
    ...
    visibility: "Public",
    aiSummary:
      "A modular cross-platform hardware emulator and assembler for the Intel 8086 microprocessor.",
    techStack: ["C++", "Qt 6"],
  ...
  // --- AI & MACHINE LEARNING ---
  {
    ...
    visibility: "Public",
    aiSummary:
      "Advanced AI research implementing Linear Gradient Matching for cross-model generalization in dataset distillation.",
  ...
  },
  {
    ...
    visibility: "Public",
    aiSummary:
      "Essential Python wrappers allowing developers to run massive Meta Llama models on standard hardware efficiently.",
    techStack: ["Python", "C++"],
    url: "https://metanthropic.vercel.app/",
    featured: false,
  },
  {
    ...
    visibility: "Private",
    aiSummary:
      "An open-source AI coding assistant designed to automate and enhance complex developer workflows.",
  ...
  },
  {
    ...
    visibility: "Public",
    aiSummary:
      "A local web app that routes queries to multiple top-tier LLMs via OpenRouter and forces them to debate and rank answers.",
  ...
  // --- OPEN SOURCE CORE CONTRIBUTIONS ---
  {
    ...
    visibility: "Public",
    aiSummary:
      "Contributions to the core source tree of the Linux operating system kernel.",
  ...
  },
  {
    ...
    visibility: "Public",
    aiSummary:
      "Contributions to the cloud-native distributed database handling extreme-scale Hybrid Transactional/Analytical Processing.",
    techStack: ["Go", "Rust"],
  ...
  },
  {
    ...
    visibility: "Public",
    aiSummary:
      "A declarative orchestration engine for building Internal Developer Platforms and managing cloud-native infrastructure.",
  ...
  },
  {
    ...
    visibility: "Public",
    aiSummary:
      "Contributions to the industry-standard declarative infrastructure-as-code orchestration tool.",
    techStack: ["Go", "HCL"],
  ...
  // --- WEB, AUTH & FRAMEWORKS ---
  {
    ...
    visibility: "Public",
    aiSummary:
      "An advanced, comprehensive authentication library designed specifically for TypeScript applications.",
  ...
  },
  {
    ...
    visibility: "Public",
    aiSummary:
      "An ORM-like library enabling developers to query PostgREST APIs securely from any JavaScript environment.",
  ...
  },
  {
    ...
    visibility: "Public",
    aiSummary:
      "A robust user management server handling JWT issuance, Row Level Security, and Magic Link authentication.",
  ...
  },
  {
    ...
    visibility: "Public",
    aiSummary:
      "A cutting-edge 3D user interface inspired by city-building games to visualize and manage developer productivity.",
