...
export default function Post() {
  return (
    <NotebookLayout meta={{ 
      ...
      <p>Architectural specification for **Unlearning** is currently being indexed. This summary outlines the systems design and formal verification of the Metanthropic charter.</p>
