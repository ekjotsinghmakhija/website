    ...
    <div className="min-h-screen bg-[#110a0a] text-stone-300 relative overflow-hidden font-sans">
      ...
      <div className="max-w-4xl mx-auto py-20 px-6 relative z-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-16 pb-6 border-b border-rose-950/50">
          <Link href="/blog" className="text-sm text-stone-500 hover:text-rose-400 flex items-center gap-2 transition-colors uppercase tracking-widest font-mono">
          ...
          <a href="https://metanthropic.com" target="_blank" rel="noopener noreferrer" className="px-5 py-2.5 bg-rose-500/10 text-rose-400 hover:bg-rose-500/20 hover:text-rose-300 rounded border border-rose-500/20 text-sm font-medium transition-all">
        ...
        <header className="mb-16">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-white tracking-tighter mb-6">
            The Unlearning Trilemma & <span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-400 to-red-600">M-NAAR</span>
          </h1>
        ...
        <article className="space-y-8 text-lg leading-relaxed text-stone-300">
          ...
          <h2 className="text-2xl font-bold text-white mt-12 mb-4">The Trilemma</h2>
          <p>
          ...
          <ul className="grid grid-cols-1 md:grid-cols-3 gap-4 my-8">
            <li className="bg-[#1a0f0f] p-5 rounded-lg border border-rose-900/30">
              <strong className="text-rose-400 block mb-2 font-mono">1. Efficacy</strong>
              Complete and verifiable erasure of the target concept.
            </li>
            <li className="bg-[#1a0f0f] p-5 rounded-lg border border-rose-900/30">
              <strong className="text-rose-400 block mb-2 font-mono">2. Utility</strong>
              Preserving the model's general knowledge and reasoning abilities.
            </li>
            <li className="bg-[#1a0f0f] p-5 rounded-lg border border-rose-900/30">
              <strong className="text-rose-400 block mb-2 font-mono">3. Efficiency</strong>
              Achieving erasure without the immense cost of retraining from scratch.
            </li>
          </ul>

          <h2 className="text-2xl font-bold text-white mt-12 mb-4">Enter M-NAAR</h2>
          <p>
