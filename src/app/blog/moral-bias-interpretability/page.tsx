    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 relative overflow-hidden font-sans selection:bg-slate-300">
      ...
      <div className="max-w-4xl mx-auto py-20 px-6 relative z-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-16 pb-6 border-b border-slate-300">
          <Link href="/blog" className="text-sm text-slate-500 hover:text-slate-900 flex items-center gap-2 transition-colors uppercase tracking-widest font-semibold">
          ...
          <a href="https://metanthropic.com" target="_blank" rel="noopener noreferrer" className="px-5 py-2.5 bg-white text-slate-800 hover:bg-slate-100 rounded-full border border-slate-200 text-sm font-medium transition-all shadow-sm">
        ...
        <header className="mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white border border-slate-200 text-slate-600 text-xs font-mono uppercase tracking-wide mb-6 shadow-sm">
            <svg className="w-4 h-4 text-slate-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"/><path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"/><path d="M2 12h20"/></svg>
            From Black Box to Glass Box
          </div>
          <h1 className="text-5xl md:text-6xl font-bold text-slate-900 tracking-tight mb-6">
            Operationalizing <span className="font-serif italic font-normal text-slate-500">Moral Bias</span> & Interpretability
          </h1>
          <p className="text-xl text-slate-600 font-light max-w-2xl leading-relaxed">
            Developing frameworks to map, understand, and steer the internal ethical representations of foundation models.
          </p>
        </header>
        ...
        <article className="space-y-10 text-lg leading-relaxed text-slate-700">
          ...
          <div className="p-8 bg-white/80 backdrop-blur-md rounded-2xl border border-slate-200 shadow-xl shadow-slate-200/50">
            <h2 className="text-2xl font-semibold text-slate-900 mb-4">Mechanistic Interpretability</h2>
          ...
          <h2 className="text-2xl font-semibold text-slate-900 mt-12 mb-4">Safety-Steered Training</h2>
          <p>
