          ...
          <div className="grid md:grid-cols-2 gap-4 my-12 not-prose">
            <div className="p-6 bg-[#0A0A0A]/80 backdrop-blur-md border border-white/10 rounded-sm hover:border-teal-500/30 transition-colors">
                <div className="flex items-center gap-3 mb-2 text-teal-400">
                    <Database size={18} />
                    <h4 className="font-serif text-lg m-0 text-white">Postgres at the Core</h4>
                </div>
            ...
            <div className="p-6 bg-[#0A0A0A]/80 backdrop-blur-md border border-white/10 rounded-sm hover:border-teal-500/30 transition-colors">
                <div className="flex items-center gap-3 mb-2 text-teal-400">
                    <Zap size={18} />
                    <h4 className="font-serif text-lg m-0 text-white">Realtime Subscriptions</h4>
                </div>
                <div className="text-sm text-gray-400 m-0 leading-relaxed">
            ...
            <div className="p-6 bg-[#0A0A0A]/80 backdrop-blur-md border border-white/10 rounded-sm hover:border-teal-500/30 transition-colors">
                <div className="flex items-center gap-3 mb-2 text-teal-400">
                    <Shield size={18} />
                    <h4 className="font-serif text-lg m-0 text-white">Row Level Security</h4>
                </div>
                <div className="text-sm text-gray-400 m-0 leading-relaxed">
            ...
            <div className="p-6 bg-[#0A0A0A]/80 backdrop-blur-md border border-white/10 rounded-sm hover:border-teal-500/30 transition-colors">
                <div className="flex items-center gap-3 mb-2 text-teal-400">
                    <Server size={18} />
                    <h4 className="font-serif text-lg m-0 text-white">Instant APIs</h4>
                </div>
                <div className="text-sm text-gray-400 m-0 leading-relaxed">
