    ...
    <>
      ...
      >
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <Link
            href="/"
            className="flex items-center gap-2 text-white font-serif font-bold tracking-tight hover:text-cyan-400 transition-colors z-50"
          >
          ...
          <div className="hidden md:flex items-center gap-6 text-sm font-mono text-gray-400">
            ...
            <a
              href={SOCIALS.email}
              className="px-4 py-1.5 bg-white/5 border border-white/10 rounded-full text-white hover:bg-white/10 transition-colors text-xs"
            >
              CONTACT
            </a>
          </div>
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="mt-auto pb-12 pt-8 flex gap-6 justify-center">
              ...
              <a
                href={SOCIALS.email}
                className="px-8 py-4 bg-cyan-500/10 border border-cyan-500/20 text-cyan-400 rounded-full font-mono text-sm"
              >
                SEND EMAIL
              </a>
            </div>
