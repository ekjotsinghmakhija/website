      ...
      <div className="grid md:grid-cols-12 gap-12 items-center">
        ...
        >
          ...
          <p className="text-lg md:text-3xl text-gray-200 font-light font-serif italic mb-8 leading-relaxed">
            Engineering{" "}
            <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent font-medium border-b border-cyan-500/30 pb-1">
              low-level systems
            </span>{" "}
            and <br />
            <span className="bg-gradient-to-r from-teal-400 to-emerald-400 bg-clip-text text-transparent font-medium border-b border-emerald-500/30 pb-1 mt-2 inline-block">
          ...
          <p className="text-gray-400 max-w-xl text-lg mb-10 leading-relaxed">
            ...
            and CTO at{" "}
            <span className="text-teal-400 font-medium hover:text-teal-300 transition-colors">
              TealBase
            </span>
            . My work focuses on high-performance inference engines, open-source
            BaaS architectures, and deterministic reasoning models.
          </p>
